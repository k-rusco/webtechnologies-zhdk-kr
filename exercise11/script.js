...
console.log("next sibling:", menu.nextElementChild);

// TODO 5: starting from the second item, log its previous sibling
console.log("previous sibling:", second.nextElementSibling);
...
console.log("number of children:" , menu.childern.lenght);